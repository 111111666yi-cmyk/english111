  ...
  return [
    {
      id: "known-100",
      title: "百词起步",
      description: "掌握 100 个单词，正式跨出第一步。",
    ...
    },
    {
      id: "known-1000",
      title: "千词成阶",
      description: "掌握 1000 个单词，开始拥有稳定阅读底盘。",
    ...
    },
    {
      id: "sentence-300",
      title: "句感成形",
      description: "完成 300 条句子训练，把词真正放进语境里。",
    ...
    },
    {
      id: "reading-30",
      title: "阅读破冰",
      description: "完成 30 篇短文，建立持续阅读的信心。",
    ...
    },
    {
      id: "world-5",
      title: "五界穿行",
      description: "通过中段地图，说明词汇闯关已经进入稳定期。",
    ...
    },
    {
      id: "review-clean",
      title: "清屏复盘",
      description: "把当前复习错题池清到 0，说明最近一轮已经补稳。",
